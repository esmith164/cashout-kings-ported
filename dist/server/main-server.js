...
import { useSSRContext, mergeProps, unref, withCtx, createTextVNode, createVNode, createSSRApp } from "vue";
...
function _sfc_ssrRender$5(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "item" }, _attrs))} data-v-b362a3d3><i data-v-b362a3d3>`);
  ssrRenderSlot(_ctx.$slots, "icon", {}, null, _push, _parent);
  _push(`</i><div class="details" data-v-b362a3d3><h3 data-v-b362a3d3>`);
...
const WelcomeItem = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["ssrRender", _sfc_ssrRender$5], ["__scopeId", "data-v-b362a3d3"]]);
const _sfc_main$6 = {};
...
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      path: "/about",
      name: "about",
      component: () => import("./assets/AboutView.1a91e369.js")
    }
  ]
});
